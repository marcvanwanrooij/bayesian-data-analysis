...
subplot(235);
plotpost(mcmc(1).beta1-mcmc(3).beta1,'xlim',[-1 1]);

%%
return

%% Doing Bayesian analysis
% Show that Bayesian analysis produces the same point estmate
% but does not produce a single number, it produces a distribution
